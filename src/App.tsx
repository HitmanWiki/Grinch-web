...
export default function App() {
  ...
  HALL OF GRINCHED
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://dedust.io/swap/TON/EQA6G0uVERDZTkLNa0drWBna1F5TSbogy7UXEWU5ERHz4uJL"
              target="_blank"
...
<div className="mt-4 flex flex-col items-center max-w-2xl mx-auto">
  ...
  <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 mt-2 text-center">
    ...
    <p className="text-[10px] text-neutral-500 font-mono">History remembers those who built.</p>
      ...
      {/* ===== SECTION: MANY FACES ===== */}
      <section id="many-faces" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-[#050505] border-b border-white/5 z-10 relative">
      ...
      <section id="verify" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-[#050505] border-b border-white/5 z-10 relative">
        <div className="text-center mb-12">
     ...
     {/* Footer */}
<footer className="bg-[#050505] border-t border-white/5 py-10 sm:py-12 z-10 relative">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
      
      {/* EXPLORE */}
      <div>
        <h3 className="text-[10px] font-mono text-neutral-500 uppercase tracking-wider mb-4">EXPLORE</h3>
        <ul className="space-y-2">
          <li><a href="#thesis" className="text-xs text-neutral-400 hover:text-neon transition-colors">About</a></li>
          <li><a href="#grinchnomics" className="text-xs text-neutral-400 hover:text-neon transition-colors">Grinchonomics</a></li>
          <li><a href="#verify" className="text-xs text-neutral-400 hover:text-neon transition-colors">Verify</a></li>
        </ul>
      </div>
  ...
  <a href="/hallofgrinched" className="text-xs text-neutral-400 hover:text-neon transition-colors inline-flex items-center gap-1.5">
    ...
    Hall of Grinched
      ...
      {/* TRACK - WITH ACTUAL ICONS */}
      {/* TRACK - WITH IMAGE ICONS */}
<div>
  <h3 className="text-[10px] font-mono text-neutral-500 uppercase tracking-wider mb-4">TRACK</h3>
  <ul className="space-y-2">
    <li>
      <a 
        href="https://www.coingecko.com/en/coins/pepe-grinch" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="flex items-center gap-2 text-xs text-neutral-400 hover:text-neon transition-colors"
      >
        <img src="/assets/CoinGecko_logo.png" alt="CoinGecko" className="w-4 h-4" />
        CoinGecko
      </a>
    </li>
    <li>
      <a 
        ...
        className="flex items-center gap-2 text-xs text-neutral-400 hover:text-neon transition-colors"
      >
        <img src="/assets/dex.png" alt="DEX Screener" className="w-4 h-4" />
        DEX Screener
      </a>
    </li>
  </ul>
      ...
      {/* CONNECT - WITH ICONS */}
      <div>
        <h3 className="text-[10px] font-mono text-neutral-500 uppercase tracking-wider mb-4">CONNECT</h3>
        <ul className="space-y-2">
          <li>
            <a 
              href="https://t.me/grinchgramCTO" 
